...
namespace saliency_sandbox {
    namespace saliency {
        ...
        class _Tracking : public _Saliency<_width,_height,_SaliencyMap<_width,_height>,saliency_sandbox::flow::_FlowField<_width,_height>> {
        private:
            typedef saliency_sandbox::flow::_FlowField<_width,_height> FlowField;
