...
namespace saliency_sandbox {
    namespace segmentation {
        ...
        using namespace saliency_sandbox::utils;
        ...
        class _SegmentedImage : public saliency_sandbox::utils::_Matrix<_width,_height,uint32_t> {
        private:
        ...
        private:
            saliency_sandbox::utils::_Matrix<_width,_height,_type>** m_data;
            _SegmentedImage<_width,_height>* m_seg;
            uint32_t m_i;
            uint32_t m_j;

        public:
            _Edge(_SegmentedImage<_width,_height>* seg,saliency_sandbox::utils::_Matrix<_width,_height,_type>** data, uint32_t x0, uint32_t y0, uint32_t x1, uint32_t y1) :
                    m_data(data),
                    m_seg(seg),
                    m_i(y0*_width+x0),
                    m_j(y1*_width+x1){
        ...
        template <uint32_t _width, uint32_t _height, typename _type>
        class _RegionGrow : public saliency_sandbox::core::Node::template Input<saliency_sandbox::utils::_Matrix<_width,_height,_type>>::template Output<_SegmentedImage<_width,_height>> {
        public:
