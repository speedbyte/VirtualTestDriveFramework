...
namespace saliency_sandbox {
    namespace saliency {
        namespace evaluation {
            ...
            class _Pearson : public _PearsonImpl,public saliency_sandbox::core::Node::template Input<saliency_sandbox::utils::_HeatmapImage<_width,_height>,saliency_sandbox::utils::_HeatmapImage<_width,_height>>::template Output<float> {
            private:
                float m_correl;
            public:
                _Pearson() {
