...
namespace saliency_sandbox {
    namespace saliency {
        namespace activation {
            ...
            class _IttiKoch : public _Saliency<_width,_height,saliency_sandbox::utils::_HeatmapImage<_width,_height>> {
            public:

                template<uint32_t _c, uint32_t _delta>
                class CenterSurroundDifference : public _Saliency<_width,_height,saliency_sandbox::utils::_HeatmapImage<_width,_height>> {
                public:
